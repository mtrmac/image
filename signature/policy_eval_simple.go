...
func (pr *prInsecureAcceptAnything) isImageAuthenticated(ctx context.Context, image types.UnparsedImage) (bool, error) {
	// prInsecureAcceptAnything semantics: Every image is allowed to run,
	// but this does not consider the signature as verified.
	return false, nil
}
...
func (pr *prReject) isImageAuthenticated(ctx context.Context, image types.UnparsedImage) (bool, error) {
