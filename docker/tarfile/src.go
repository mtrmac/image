...
func (s *Source) GetOriginalManifest(ctx context.Context, instanceDigest *digest.Digest) ([]byte, string, error) {
	return s.internal.GetOriginalManifest(ctx, instanceDigest)
}
