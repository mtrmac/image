...
func (s *ociArchiveImageSource) GetOriginalManifest(ctx context.Context, instanceDigest *digest.Digest) ([]byte, string, error) {
	return s.unpackedSrc.GetOriginalManifest(ctx, instanceDigest)
}
